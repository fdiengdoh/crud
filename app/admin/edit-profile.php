...
<div class="container form-container mt-5">
  ...
  <div class="mb-4">
    <img src="<?= BASE_URL . '/' . htmlspecialchars($profilePicture); ?>" alt="Profile Picture" class="img-fluid rounded-circle" style="max-width: 150px;">
  </div>
  ...
  <a href="<?= BASE_URL ?>/" class="btn btn-secondary mt-3">Back to Dashboard</a>
</div>
