...
// Ensure init.php has been loaded so that $auth and BASE_URL are defined.
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="authNavbar">
        <ul class="navbar-nav ms-auto">
          ...
          <?php endif; ?>
          <li class="nav-item"><a class="nav-link text-white" href="<?= $link->getUrl('/') ?>"><i class="bi bi-browser-safari"></i> View Blog</a></li>
