...
?>
  <div class="container">
          ...
          <?php foreach ($userPosts as $post): ?>
            <tr>
              ...
              <td>
                ...
                <a href="<?= BASE_URL ?>/post-delete/?id=<?php echo $post['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to move this post to draft?');">Move to Draft</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
    ...
    <?php if ($auth->hasRole(Role::ADMIN)): ?>
      <a href="<?= BASE_URL ?>/admin" class="btn btn-info">Admin Panel</a>
    <?php endif; ?>
  </div>
